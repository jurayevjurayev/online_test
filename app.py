...
def certificate_pdf():
    ...
    font_size_name = 150  # Nom uchun shrift o'lchami
    font_size_result = 60  # Natija uchun shrift o'lchami
    ...
    if os.path.exists(template_path):
        ...
        if font_path:
            ...
            font_test = ImageFont.truetype(font_path, 60)
        else:
